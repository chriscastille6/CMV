...
table2 %>%
  ...
  "Values in parentheses are z-scores and describe the difference between the estimated correlations.") %>%
  landscape() %>%
...
Study 2 provided further evidence that using a specific proximal remedy can influence one's substantive conclusions in unforeseen ways. While some effects were anticipated, many were not. We suspected that since a specific remedy should address a specific method effect (e.g., the cover story should eliminate demand effects; item randomization should eliminate serial item-order effects), the estimated substantive effects would be relatively weaker compared to a condition where no remedy was applied. Others (i.e., colleagues who suggested we conduct this study) suggested that perhaps a single remedy would emerge to explain the pattern of results obtained in Study 1. While this latter view seems untenable in light our data, the reliability decomposition for Study 2 favors the former view.
